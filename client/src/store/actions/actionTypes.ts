...
export const REMOVE_WIDGET_INITIAL = 'REMOVE_WIDGET_INITIAL'
...
export const GET_CITY_WEATHER_INITIAL = 'GET_CITY_WEATHER_INITIAL'
export const GET_CITY_WEATHER_START = 'GET_CITY_WEATHER_START'
export const GET_CITY_WEATHER_SUCCESS = 'GET_CITY_WEATHER_SUCCESS'
export const GET_CITY_WEATHER_FAILED = 'GET_CITY_WEATHER_FAILED'
